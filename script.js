document.addEventListener("DOMContentLoaded", () => {
  ...
  const definiciones = [
      new Definicion("Axolote", "Ambystoma mexicanum", "El axolote es un anfibio con regeneración única.", "Lagos de agua dulce", "Nunca pasa a la etapa adulta debido a la neotenia."),
      new Definicion("Cuervo", "Corvus corax", "Ave inteligente, capaz de resolver problemas y recordar rostros.", "Bosques y ciudades", "Puede imitar sonidos humanos."),
  ...
  loginBtn.addEventListener("click", () => {
      loginBtn.textContent = loginBtn.textContent === "Iniciar Sesión" ? "Cerrar Sesión" : "Iniciar Sesión";
  });
});
